...
const FAQ = [
  ...
  { q: "Як прийти на першу зустріч?", a: "Найпростіше — зателефонувати на вказані номери і там підкажуть варіанти. Можна також просто прийти за адресою з довідника нижче." },
  { q: "Чи це справді анонімно?", a: "Так. Прийнято називати лише ім'я (або й вигадане), ми не питаємо про ваше минуле, яким би не були ваші проблеми - серед нас є ті, хто пережив їх також. Анонімність — духовна основа спільноти." },
  { q: "Чи є онлайн-зустрічі?", a: "Так, українських онлайн-груп зараз чимало — у Zoom і інших месенджерах. Це зручний спосіб спробувати долучитися до учасників Програми, не виходячи з дому." },
  { q: "Що робити, якщо стався зрив?", a: "Найзручніше це прийти на зібрання і після завершення поговорити з тим, чия історія вам найбільше відгукнулася." },
  { q: "Чи можуть прийти родичі?", a: "Для близьких людей узалежннеих існує окрема спільнота — Ал-Анон. Там рідні діляться власним досвідом і вчаться піклуватися про себе, поки близька людина шукає свій шлях." },
...
const QUIZ_QUESTIONS = [
  ...
  "Чи траплялися у Вас протягом останнього року проблеми на роботі через надмірне вживання алкоголю?",
  "Чи виникали у Вас через випивку прикрощі вдома чи спілкуванні з родиною?",
...
function About() {
  const cards = [
    ...
    { t: "Без оцінки", d: "Ніхто не осуджує і не порівнює. Кожен говорить лише про свій досвід виходу з алкогольної залежності." },
  ...
  const [messages, setMessages] = useState<{ role: "user" | "assistant"; content: string }[]>([
    {
      role: "assistant",
      content:
        "Вітаю. Якщо є додаткові питання, - Я вбудований Асистент коротко відповім про АА та Програмау 12 Кроків АА. Розмова не зберігається.",
    },
  ]);
          ...
          >
            ...
            <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-forest/90">
              {isAffected ? (
                ...
                <>
                  <p>
                    Ви відповіли «Так» менш ніж на 4 запитання. Це не означає,
                    що проблеми немає — і не означає, що вона точно є. Тільки
                    ви можете оцінити власну ситуацію.
                  </p>
                  <p>
                    Якщо щось у ваших відповідях зачіпило вас, або ви просто
                    хочете зрозуміти більше про АА — ніхто не заперечуватиме.
                    АА нічого не нав'язує: ми просто ділимося досвідом людей,
                    які через це пройшли. Довідник груп і чат нижче відкриті для
                    вас, без жодних зобов'язань.
                  </p>
                </>
              )}
            </div>
